...
* The following dependencies are not known to work with Spring Native: 'Spring Configuration Processor, Spring Boot DevTools, Spring REST Docs'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 demo2API:0.0.1-SNAPSHOT
```
